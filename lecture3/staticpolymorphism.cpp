...
It can be of two types: function overloading and operator overloading
*/
...
ManualCar operator+(const ManualCar& other) {
    ManualCar result("Combined", "Car");
    result.currentSpeed = this->currentSpeed + other.currentSpeed;
    return result;
}
